...
(function (ngPhotosphere) {
    ...
    var photosphere = (function (_super) {
        ...
        function photosphere($window) {
            ...
            var css = '';//'<style> .ascreen:link,.ascreen:visited{display:block;width:120px;font-weight:700;color:#FFF;background-color:#98bf21;text-align:center;padding:4px;text-decoration:none}.ascreen:active,.ascreen:hover{background-color:#7A991A}</style>';
            var navbar = '';//<ul> <li><a class="ascreen" href="" ng-click="fullscreen()">See fullscreen</a></li> </ul>';
            vm.template = css + '<div style="width:100%;" ng-scope-element="' + vm.id + '">' + navbar + '</div>';
            vm.fullscreen = false;
            var directive = {};
